var ZOHO = (function () {
  ...
  return {
    ...
    CRM: (function () {
        ...
        if ("CONNECTOR" != b) {
          ...
          if (f) {
            var p,
              g = [];
            for (p in f)
              g.push(encodeURIComponent(p) + "\x3d" + encodeURIComponent(f[p]));
            p = g.join("\x26");
            b += (-1 < b.indexOf("?") ? "\x26" : "?") + p;
          }
          c = {
      ...
      function h(a, e) {
        return d({ category: "CONFIG", type: a, nameSpace: e });
      }
      function g(a) {
        var e = { category: "USER" };
        a.ID
          ...
          : a.Type &&
            ...
            a.per_page && (e.per_page = a.per_page));
        return d(e);
      }
      function l(a) {
        return d({
      ...
      return {
        ...
        API: {
          ...
          getAllRecords: function (a) {
            return d({ category: "READ", APIData: a });
          },
          ...
          getAllUsers: function (a) {
            return g({ Type: a.Type, page: a.page, per_page: a.per_page });
          },
          getUser: function (a) {
            return g({ ID: a.ID });
          },
          ...
          getAllProfiles: function (a) {
            return d({ category: "PROFILES", type: "GET_ALL_PROFILES" });
          },
          getProfile: function (a) {
            return d({ category: "PROFILES", type: "GET_PROFILE", ID: a.ID });
          },
        ...
        UI: {
          ...
          Dialer: {
            maximize: function () {
              return f({ action: { telephony: "MAXIMIZE" } });
            },
            minimize: function () {
              return f({ action: { telephony: "MINIMIZE" } });
            },
            notify: function () {
              return f({ action: { telephony: "NOTIFY" } });
            },
          },
          Record: {
            open: function (a) {
              a = {
                action: { record: "OPEN" },
                data: { Entity: a.Entity, RecordID: a.RecordID },
              };
              return f(a);
            },
            edit: function (a) {
            ...
            populate: function (a) {
              return f({ action: { record: "POPULATE" }, data: a });
            },
          },
          Popup: {
            close: function () {
              return f({ action: { popup: "CLOSE" } });
            },
            closeReload: function () {
              return f({ action: { popup: "CLOSE_RELOAD" } });
            },
          },
        },
        HTTP: {
          ...
          post: function (a) {
            return c("wget.post", a);
          },
        },
        CONNECTOR: {
          invokeAPI: function (a, b) {
            return c(a, b, "CONNECTOR");
          },
        },
        CONNECTION: {
          invoke: function (a, b) {
            ...
            f.headers = JSON.stringify(b.headers);
            c.data = f;
            return d({
...
var ZSDKUtil = (function (b) {
    ...
    b.isDevMode = function () {
      return k && k.isDevMode;
    };
    b.isLogEnabled = function () {
      return k && k.isLogEnabled;
    };
    b.getLogger = function () {
      (c && c instanceof g) || (c = new g());
      return c;
    };
    b.Sleep = function (b) {
  ...
  ZSDKMessageManager = (function (b) {
    function g(a) {
      ...
      try {
        ...
        u.Error("[SDK.MessageHandler] \x3d\x3e ", B.stack);
      }
    }
    function d(a, b) {
      q = window.parent;
    ...
    function h(a, b, c) {
      n.hasOwnProperty(a) &&
        (b ? n[a].resolve(c) : n[a].reject(c), (n[a] = void 0), delete n[a]);
    }
    function w(a) {
    ...
    b.RegisterApp = function () {
      var b = {
        type: "SDK.EVENT",
        eventName: "REGISTER",
        appOrigin: encodeURIComponent(a()),
      };
  ...
  ZSDKEventManager = (function (b) {
    ...
    b.AttachEventListener = function (b, c) {
      "function" === typeof c &&
        (Array.isArray(d[b]) || (d[b] = []), d[b].push(c));
    };
    ...
    b.NotifyInternalEventHandler = function (b, c) {
      var d = c.eventName;
      "__APP_INIT__" === d
        ? (b.SetContext(c.data), b.ExecuteLoadHandler())
        : "__APP_CONTEXT_UPDATE__" === d &&
          (b.UpdateContext(c.data), b.ExecuteContextUpdateHandler());
    };
    return b;
...
function ZSDK() {
  function b() {
    "function" !== typeof n
      ? x.Error("No OnLoad Handler provided to execute.")
      : C
      ? x.Error("OnLoad event already triggered.")
      : (n.call(m, m), (C = !0));
  }
  function g() {
    q.call(m, m);
